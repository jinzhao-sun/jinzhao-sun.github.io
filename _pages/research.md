...
because of the development of other competing instabilities, in particular, the in-plane frustrated magnetic interactions as found in our series of experiments. Some interesting findings on the $$L$$ modulation in FeSe-based superconductors are shown in the [paper](https://arxiv.org/pdf/2407.05548), which suggests a ferromagnetic inter-layer coupling in FeSe and sheds light on the absence of magnetic order.
